...
for (const s of [...(batch4.inspected as Record<string, unknown>[]), ...(batch8.inspected as Record<string, unknown>[]), ...(batch9.inspected as Record<string, unknown>[]), ...(batch12.inspected as Record<string, unknown>[]), ...(batch14.inspected as Record<string, unknown>[])]) {
