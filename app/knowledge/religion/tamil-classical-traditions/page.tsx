    ...
    <main className="min-h-screen bg-[#09090b] px-6 py-16 text-zinc-300 selection:bg-teal-300 selection:text-black sm:px-12">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-6 border border-amber-800/60 bg-amber-950/10 p-7">
          ...
          <div className="mt-3 flex flex-wrap items-end justify-between gap-5"><div className="max-w-3xl"><h2 className="text-3xl font-semibold text-white">Forty-eight passage, relationship, name, and reception guides</h2><p className="mt-3 text-sm leading-6 text-zinc-400">Move from the overview into exact Paripāṭal ranges, all pairwise landscape relations, divine-name disambiguation, and typed Māyōṉ-to-Āḻvār reception links.</p></div><Link href={TAMIL_SOURCE_ATLAS_PATH} className="font-mono text-[10px] uppercase tracking-widest text-amber-300 hover:text-white">Open the source atlas →</Link></div>
        </section>
