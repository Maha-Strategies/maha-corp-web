import { handleWso2ContextResponse } from '@/lib/integrations/wso2-context-interceptor'
...
export async function POST(request: Request) {
  ...
  return json(handleWso2ContextResponse(body, process.env.WSO2_CONTEXT_INTERCEPTOR_SECRET))
}
