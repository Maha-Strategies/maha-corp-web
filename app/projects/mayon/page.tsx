  ...
  return (
    <main className="evidence-page">
      <article className="evidence-container evidence-container--narrow">
        ...
        <p className="mt-5 text-sm text-[var(--text-secondary)]">Looking for the app itself, current availability, screenshots, classroom resources, and privacy information? <Link href="/mayon" className="text-[var(--status-sourced)] underline">Open the Mayon Volcano hub</Link>.</p>
