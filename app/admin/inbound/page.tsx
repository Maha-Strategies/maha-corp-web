...
type Submission = { public_id: string; offer_id: string; requester_name: string; requester_email: string; requester_organization: string | null; decision: string; question: string; deadline: string | null; qualification_status: string; qualification_reasons: string[]; operations_status: string; reviewer_note: string | null; revenue_opportunity_id: string | null; created_at: string }
