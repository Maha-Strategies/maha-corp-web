...
type Correction = {
  blockerCode: string
  kind: 'source-exact-locator' | 'source-publication-date' | 'claim-evidence-maturity' | 'source-claim-alignment'
