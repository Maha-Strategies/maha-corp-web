  ...
  return (
    <main className="evidence-page">
      ...
      <article className="prose max-w-none font-light tracking-wide leading-relaxed space-y-6">
        ...
        <div className="border border-[var(--border-default)] bg-[var(--surface-raised)] p-6 space-y-4 mt-8">
          <div className="font-mono text-xs tracking-widest text-[var(--status-sourced)] uppercase">
            STRUCTURAL MANDATE
          </div>
