...
type RecordSnapshot = {
  ...
  sources: Array<{ id: string; title: string; authors: string[]; publishedAt: string; url: string; exactLocator: string; establishes: string; boundary: string; rights: { basis: string; note: string } }>
