    ...
    <main className="min-h-screen bg-[#0a0a0c] text-zinc-300 selection:bg-indigo-500 selection:text-white">
      ...
      <article className="max-w-3xl mx-auto px-6 py-20 sm:py-28">
        ...
        <header className="border-b border-zinc-800 pb-10 mb-12">
          <p className="font-mono text-[10px] text-indigo-400 tracking-widest uppercase mb-5">[ Plain-English AI guide ]</p>
          <h1 className="text-4xl sm:text-5xl font-light text-white leading-[1.1] tracking-tight mb-6">How do large language models learn?</h1>
        ...
        <footer className="mt-16 pt-8 border-t border-zinc-800">
          ...
          <div className="flex flex-col gap-3">
            <Link href="/books/the-synthetic-self/the-learning-machine" className="text-zinc-300 hover:text-white transition-colors">Read Chapter 1: The Learning Machine ↗</Link>
            <Link href="/books/the-synthetic-self" className="text-zinc-300 hover:text-white transition-colors">Return to The Synthetic Self ↗</Link>
          </div>
        </footer>
      </article>
    </main>
