    ...
    <main className="evidence-page">
      ...
      <article className="evidence-container evidence-container--narrow">
        ...
        <header className="border-b border-[var(--border-default)] pb-10 mb-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-light text-[var(--text-primary)] leading-[1.1] tracking-tight mb-6">The blind watchmaker opens his eyes</h1>
        ...
        <footer className="mt-16 pt-8 border-t border-[var(--border-default)]">
          ...
          <div className="flex flex-col gap-3">
            <Link href="/books/the-unfinished-species/what-is-natural-selection" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">What is natural selection? ↗</Link>
            <Link href="/books/the-unfinished-species" className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">Return to the book’s table of contents ↗</Link>
          </div>
        </footer>
      </article>
    </main>
