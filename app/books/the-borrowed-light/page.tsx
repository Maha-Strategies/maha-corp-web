  ...
  return <main className="min-h-screen bg-[#0a0a0c] text-zinc-300 selection:bg-indigo-500 selection:text-white">
    ...
    <article className="max-w-4xl mx-auto px-6 py-20 sm:py-28">
      <header className="max-w-3xl border-l border-indigo-500 pl-6 sm:pl-8">
        <p className="font-mono text-xs text-indigo-300 tracking-widest uppercase mb-5">[ Maha Strategies // Open Edition ]</p>
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-light text-white leading-[1.08] tracking-tight mb-5">The Borrowed Light</h1>
        <p className="text-lg sm:text-xl text-zinc-400 font-light leading-relaxed mb-3">{book.subtitle}</p>
        <p className="font-mono text-xs text-zinc-500 tracking-widest uppercase">By Mayone Maha Rajan</p>
      </header>
      <section className="mt-16 max-w-3xl">
        <p className="text-xl sm:text-2xl text-zinc-200 font-light leading-relaxed mb-6">The self can feel entirely private and self-made. This book follows the contrary, more generous possibility: that a person is formed in relationship, borrowing light without becoming any less real.</p>
