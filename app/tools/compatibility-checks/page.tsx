...
export default function CompatibilityChecksPage() {
  return <main className="evidence-page"><div className="evidence-container">
    <header className="max-w-5xl border-t border-[var(--border-default)] pt-5">
      <p className="evidence-kicker">Free explanations · draft rules · payment disabled</p>
    ...
    <section id="celestial" className="evidence-section">
      ...
      <p className="evidence-copy mt-4">Proposed price: 0.007 USDC. Purchase remains disabled pending price and rule-set approval.</p>
      ...
      <Link className="evidence-link mt-5 inline-block" href="/api/v1/micro/celestial-result-compatibility">Read the draft input/output contract</Link>
    </section>
    <section id="evidence" className="evidence-section">
      ...
      <p className="evidence-copy mt-4">Proposed price: 0.0105 USDC per batch of one to ten pairs. The draft rules require review before release.</p>
      ...
      <Link className="evidence-link mt-5 inline-block" href="/api/v1/micro/evidence-frame-compatibility">Read the draft input/output contract</Link>
    </section>
