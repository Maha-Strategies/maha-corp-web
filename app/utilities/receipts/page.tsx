  ...
  return (
    <main className="evidence-page">
      <div className="evidence-container evidence-container--narrow">
        <Link href="/" className="font-mono text-[11px] uppercase tracking-widest text-[var(--text-muted)] hover:text-[var(--text-primary)]">← Maha Strategies</Link>
        <p className="mt-12 font-mono text-[10px] uppercase tracking-widest text-[var(--status-verified)]">[ Micro-utility · receipt → CSV ]</p>
        <h1 className="mt-5 text-4xl font-light leading-tight tracking-tight text-[var(--text-primary)] sm:text-6xl">Messy receipt in. Clean CSV out.</h1>
        <p className="mt-7 max-w-2xl text-lg leading-relaxed text-[var(--text-secondary)]">
        ...
        <section className="mt-16 border-t border-[var(--border-default)] pt-10">
          <p className="font-mono text-[10px] uppercase tracking-widest text-[var(--status-verified)]">[ Batch run ]</p>
          <h2 className="mt-4 text-2xl font-light tracking-tight text-[var(--text-primary)] sm:text-3xl">Have a stack of them? Run a batch.</h2>
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-[var(--text-secondary)]">
            ...
            CSV — <strong className="text-[var(--text-secondary)]">upload photos or paste text, or mix both</strong>. Pay once, no
            account, no login. Unparseable receipts are dropped, and a run where nothing parses is refunded automatically.
          </p>
          <ReceiptBatch />
        </section>

        <section className="mt-16 border-t border-[var(--border-default)] pt-8">
          <p className="font-mono text-[10px] uppercase tracking-widest text-[var(--text-muted)]">How it stays honest</p>
