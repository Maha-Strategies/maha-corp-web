  ...
  return (
    <main className="evidence-page">
      ...
      <div className="evidence-container">
        ...
        <section className="evidence-section" aria-labelledby="directory-heading"><div className="evidence-inset"><p className="evidence-kicker">Public federation</p><h2 id="directory-heading" className="evidence-section-title mt-4">Navigate every canonical route.</h2><p className="evidence-copy mt-5">The site directory connects all 4,000 released routes across Knowledge, Research, Policy, Publish, Maha OS, and the author properties from this homepage.</p><Link href="/directory" className="evidence-link mt-6 inline-block font-mono text-xs uppercase tracking-widest">Open the complete directory ↗</Link></div></section>
