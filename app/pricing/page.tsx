    ...
    <main className="evidence-page">
      ...
      <div className="evidence-container evidence-container--narrow">
        ...
        <section id="assessment-options" className="evidence-section scroll-mt-24" aria-labelledby="assessment-heading">
          ...
          <div className="mt-7 flex flex-wrap gap-3"><Link className="evidence-action evidence-action--primary" href="/context-control">Read the full assessment page ↗</Link><a className="evidence-action evidence-action--secondary" href="mailto:mayone@mahastrategies.com?subject=Context%20Control%20Evidence%20Assessment">Request a bounded assessment ↗</a><Link className="evidence-action evidence-action--secondary" href="/demo">Watch the partner demonstration ↗</Link></div>
        </section>
