...
const legislativeSeeds = [
  ...
  },
  {
    ...
    summary: 'Treating deceptive interface design as an unfair trade practice.',
    body: [
  ...
  },
  {
    ...
    summary: 'A civilian service corps for ecological repair, funded by redirected subsidies.',
    body: [
  ...
  },
  {
    ...
    summary: 'Protecting local jurisdictions right to set higher standards than the national floor.',
    body: [
    ...
    <main className="evidence-page">
      ...
      <div className="evidence-container">
        <section className="evidence-section">
          <p className="evidence-kicker">[ Think Tank & Applied Research ]</p>
          <h1 className="evidence-title">Policy &amp; Statecraft</h1>
        ...
        <section className="evidence-section">
          <h2 className="evidence-section-title">The Saturnian Corrective</h2>
          <div className="evidence-copy mt-6 space-y-4">
            <p>
        ...
        <section className="evidence-section">
          <h2 className="evidence-section-title">Ecological Statecraft &amp; Biological Capital</h2>
          <div className="evidence-copy mt-6 space-y-4">
            <p>
        ...
        <section className="evidence-section">
          <h2 className="evidence-section-title">Asymmetric Statecraft: The Enclave Strategy</h2>
          <div className="evidence-copy mt-6 space-y-4">
            <p>
        ...
        <section className="evidence-section">
          <p className="evidence-kicker">[ Legislative Architecture ]</p>
          <h2 className="evidence-section-title">Five Platform Seeds</h2>
          <p className="evidence-copy mt-4">Five proposed platforms for national reconstruction, presented as directional policy arguments.</p>

          <div className="mt-7 space-y-6">
            {legislativeSeeds.map((seed) => (
              <article key={seed.id} id={seed.id} className="evidence-card">
                <h3 className="evidence-card-title">
                  {seed.href ? <Link href={seed.href} className="evidence-link">{seed.title}</Link> : seed.title}
                </h3>
                <p className="evidence-kicker mt-3">{seed.summary}</p>
                <div className="evidence-copy mt-4 space-y-4">
                  {seed.body.map((para, i) => (
                    <p key={i}>{para}</p>
                  ))}
                </div>
                {seed.href && (
                  <Link href={seed.href} className="evidence-link mt-6 inline-block">
                    Read the directive &#8599;
                  </Link>
                )}
              </article>
        ...
        <section className="evidence-section">
          <h2 className="evidence-section-title">The Fermi Filter &amp; Civilizational Trajectory</h2>
          <div className="evidence-copy mt-6 space-y-4">
            <p className="evidence-kicker">Speculative framing device for our long-horizon thesis, not an empirical claim.</p>
            <p>
            ...
            <p className="evidence-kicker">Stop consuming. Start shining. Hold your orbit.</p>
          </div>
        </section>
