...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/celestial`, lastModified: new Date('2026-08-17') },
    { url: `${baseUrl}/celestial/birth`, lastModified: new Date('2026-08-17') },
    { url: `${baseUrl}/celestial/verify`, lastModified: new Date('2026-08-17') },
