...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/case-studies`, lastModified: new Date('2026-07-26'), changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${baseUrl}/tools/constraint-studio`, lastModified: new Date('2026-07-27'), changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${baseUrl}/mps/learn/implementation`, lastModified: new Date('2026-07-28'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/mps/learn/implementation/individuals`, lastModified: new Date('2026-07-28'), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/mps/learn/implementation/schools`, lastModified: new Date('2026-07-28'), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/mps/learn/implementation/small-organizations`, lastModified: new Date('2026-07-28'), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/mps/learn/implementation/developers`, lastModified: new Date('2026-07-28'), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/mps/learn/glossary`, lastModified: new Date('2026-07-28'), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${baseUrl}/mps/learn/faq`, lastModified: new Date('2026-07-28'), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${baseUrl}/mps/learn/methodology`, lastModified: new Date('2026-07-28'), changeFrequency: 'monthly', priority: 0.6 },
    ...
    { url: `${baseUrl}/mps/preflight/example`, lastModified: new Date('2026-07-27'), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/overclock`, lastModified: new Date('2026-07-16'), changeFrequency: 'monthly', priority: 0.6 },
    { url: `${baseUrl}/books`, lastModified: new Date('2026-07-28'), changeFrequency: 'weekly', priority: 0.9 },
    { url: `${baseUrl}/books/mcp-access`, lastModified: new Date('2026-07-20'), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/books/the-borrowed-light`, lastModified: new Date('2026-07-28'), changeFrequency: 'weekly', priority: 0.8 },
    { url: `${baseUrl}/books/the-borrowed-light/m-theory-faq`, lastModified: new Date('2026-07-28'), changeFrequency: 'monthly', priority: 0.8 },
