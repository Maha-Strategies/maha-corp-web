...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/tools/ai-boundary-planner`, lastModified: new Date('2026-07-29'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/tools/constraint-studio`, lastModified: new Date('2026-07-27'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/tools/token-calc`, lastModified: new Date('2026-07-29'), changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${baseUrl}/mps/learn/reference-architectures`, lastModified: new Date('2026-07-29'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/mps/learn/reference-architectures/offline-field-capture-authorized-cloud-escalation`, lastModified: new Date('2026-07-29'), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/mps/learn/reference-architectures/school-accessibility-assistant`, lastModified: new Date('2026-07-29'), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${baseUrl}/mps/learn/reference-architectures/internal-approved-document-search`, lastModified: new Date('2026-07-29'), changeFrequency: 'monthly', priority: 0.7 },
    ...
    { url: `${baseUrl}/recipes/bazaar-discovery-to-payment`, lastModified: new Date('2026-08-08'), changeFrequency: 'monthly', priority: 0.8 },
