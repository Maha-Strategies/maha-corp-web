...
export const SEMICONDUCTOR_PROCESS_PHASES: SemiconductorMapPhase[] = [
  {
    ...
    steps: [
      { id: 'requirements', label: 'Requirements capture', description: 'Define functions, interfaces, operating conditions, lifetime, regulatory obligations, and economic targets.', category: 'design' },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'rtl-custom-design', label: 'RTL & custom circuit design', description: 'Implement digital logic and design custom analog, RF, memory, I/O, and physical IP.', category: 'design' },
      { id: 'functional-verification', label: 'Functional verification', description: 'Use simulation, formal methods, emulation, prototypes, coverage, and hardware/software co-verification.', category: 'design', repeat: true },
      ...
      { id: 'logic-synthesis', label: 'Logic synthesis', description: 'Map RTL into technology cells under timing, power, area, test, and physical constraints.', category: 'design' },
      ...
      { id: 'place-route', label: 'Place, clock & route', description: 'Place cells, build clock networks, route signals, and optimize congestion, timing, power, and integrity.', category: 'design', repeat: true },
      { id: 'extraction-signoff', label: 'Extraction & signoff analysis', description: 'Close timing, power, IR drop, electromigration, signal integrity, thermal, and variation requirements.', category: 'quality', repeat: true },
      { id: 'physical-verification', label: 'Physical verification', description: 'Run design-rule, layout-versus-schematic, electrical-rule, density, antenna, and manufacturability checks.', category: 'quality', repeat: true },
      { id: 'tapeout', label: 'Tape-out', description: 'Freeze the released layout, checksums, revisions, test content, and manufacturing handoff package.', category: 'design' },
    ],
  ...
  },
  {
    ...
    steps: [
      { id: 'data-prep', label: 'Mask data preparation', description: 'Fracture layout, apply process bias, dummy features, optical/proximity corrections, and computational patterning.', category: 'mask' },
      { id: 'mask-write', label: 'Mask writing', description: 'Expose the reticle blank with an electron-beam writer and tightly controlled data path.', category: 'mask' },
      ...
      { id: 'mask-inspection', label: 'Inspection & repair', description: 'Find printable defects, repair where allowed, and reinspect repaired regions.', category: 'quality', repeat: true },
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'crystal-growth', label: 'Single-crystal growth', description: 'Grow an oriented ingot while controlling dopant, resistivity, oxygen, defects, and diameter.', category: 'substrate' },
      ...
      { id: 'wafer-slicing', label: 'Wafer slicing', description: 'Slice the ingot into wafers with controlled thickness and kerf damage.', category: 'substrate' },
      ...
      { id: 'wafer-polish', label: 'Chemical-mechanical polish', description: 'Create the low-roughness, high-flatness device surface.', category: 'substrate' },
      { id: 'wafer-clean', label: 'Final clean', description: 'Remove particles, metals, organics, and native residues to the incoming specification.', category: 'substrate' },
  ...
  },
  {
    ...
    steps: [
      { id: 'initial-clean', label: 'Surface clean & preparation', description: 'Condition the wafer surface and remove contamination before each sensitive module.', category: 'modify', repeat: true },
      ...
      { id: 'activation-anneal', label: 'Activation & thermal processing', description: 'Repair lattice damage, activate dopants, form interfaces, and manage diffusion within the thermal budget.', category: 'modify', articleId: 'process-ion-implantation-annealing' },
      ...
      { id: 'feol-control', label: 'Inline metrology & electrical monitors', description: 'Measure CDs, overlay, profiles, films, defects, sheet resistance, and device test structures after critical modules.', category: 'quality', repeat: true },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'post-etch-clean', label: 'Post-etch clean', description: 'Remove polymers, residues, and exposed-interface contamination before metallization.', category: 'modify', repeat: true },
  ...
  },
  {
    ...
    steps: [
      { id: 'wat', label: 'Wafer acceptance test', description: 'Measure process-control structures and electrical parameters that characterize the completed wafer process.', category: 'test' },
      ...
      { id: 'wafer-sort', label: 'Wafer probe / sort', description: 'Contact each die, execute structural and functional tests, assign bins, and preserve the wafer map.', category: 'test' },
      { id: 'yield-analysis', label: 'Yield analysis & disposition', description: 'Separate systematic from random loss, contain excursions, and decide wafer, lot, or die disposition.', category: 'quality', repeat: true },
      { id: 'bumping-rdl-option', label: 'Bumping or wafer-level RDL', description: 'Optionally form redistribution and die/package interconnect structures before singulation.', category: 'assembly', articleId: 'process-advanced-packaging' },
      { id: 'backgrind', label: 'Backgrind & thinning', description: 'Thin the wafer to package requirements while controlling stress, damage, contamination, and handling.', category: 'assembly' },
      { id: 'dicing', label: 'Dicing or stealth singulation', description: 'Separate die, inspect them, and maintain identity between wafer coordinates and physical units.', category: 'assembly' },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { id: 'wire-flip-hybrid', label: 'Electrical interconnect', description: 'Create wire bonds, flip-chip joints, microbumps, copper bonds, TSV/RDL paths, or leadframe connections.', category: 'assembly', articleId: 'process-advanced-packaging' },
      { id: 'underfill-mold', label: 'Underfill, mold & cure', description: 'Reinforce or encapsulate sensitive structures while controlling voids, stress, flow, and contamination.', category: 'assembly' },
  ...
  },
  {
    ...
    steps: [
      { id: 'final-ate', label: 'Final ATE test', description: 'Test digital, memory, analog, RF, mixed-signal, power, and interface functions across specified conditions.', category: 'test' },
      ...
      { id: 'burn-in-screen', label: 'Burn-in or stress screen', description: 'Apply product-specific stress where justified to detect early-life or latent defects.', category: 'test' },
      { id: 'slt', label: 'System-level test', description: 'Exercise selected units or production populations in a closer-to-use hardware and software environment.', category: 'test' },
      { id: 'qualification', label: 'Product & package qualification', description: 'Run environmental, mechanical, electrical, package, and lifetime stresses against the intended mission profile.', category: 'quality' },
      { id: 'failure-analysis', label: 'Failure analysis', description: 'Localize, expose, identify, and verify root causes using electrical, physical, chemical, and materials methods.', category: 'quality', repeat: true },
