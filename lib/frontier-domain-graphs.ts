...
const domainSeeds: readonly DomainSeed[] = [
  {
    ...
    sources: [
      ...
      { key: 'stellarator-review', title: 'Stellarators as a fast path to fusion', authors: ['A. H. Boozer'], publisher: 'Nuclear Fusion', publishedAt: '2021-05-04', url: 'https://doi.org/10.1088/1741-4326/abf3b3', doi: '10.1088/1741-4326/abf3b3', locator: 'Sections on magnetic-field design, coils, confinement, and reactor implications.', establishes: 'The review analyzes stellarator magnetic geometry and engineering questions for fusion systems.', boundary: 'A proposed path and modeled configuration do not establish a built commercial reactor.' },
  ...
  },
  {
    ...
    sources: [
      ...
      { key: 'wide-bandgap', title: 'Wide-bandgap semiconductors for extreme temperature applications', authors: ['Jerry L. Hudgins', 'Grigory S. Simin', 'Enrico Santi', 'M. Asif Khan'], publisher: 'IEEE Transactions on Power Electronics', publishedAt: '2003-05-01', url: 'https://doi.org/10.1109/TPEL.2003.810840', doi: '10.1109/TPEL.2003.810840', locator: 'Material-property comparison and SiC, GaN, and diamond device sections.', establishes: 'The paper compares material properties and device considerations for wide-bandgap semiconductors in high-temperature power applications.', boundary: 'Intrinsic material properties do not determine wafer quality, epitaxial defect density, package reliability, or cost.' },
    ],
  },
  {
    domain: {
    ...
    sources: [
      ...
      { key: 'cell-free', title: 'Cell-free synthetic biology: Engineering in an open world', authors: ['Michael C. Jewett', 'Zachary Z. Sunoyama'], publisher: 'Current Opinion in Biotechnology', publishedAt: '2008-12-01', url: 'https://doi.org/10.1016/j.copbio.2008.10.002', doi: '10.1016/j.copbio.2008.10.002', locator: 'Cell-free platform, extract, energy, expression, and engineering sections.', establishes: 'The review describes cell-free transcription-translation platforms and the engineering variables exposed outside intact cells.', boundary: 'In-vitro expression yield does not establish cellular, organismal, manufacturing, or clinical performance.' },
  ...
  },
  {
    ...
    sources: [
      ...
      { key: 'bioenergetics', title: 'A roadmap for the characterization of energy metabolism in human cells', authors: ['Ajit S. Divakaruni', 'Andre N. Murphy'], publisher: 'Nature Chemical Biology', publishedAt: '2014-04-17', url: 'https://doi.org/10.1038/nchembio.1526', doi: '10.1038/nchembio.1526', locator: 'Respiration assay design, oxygen-consumption components, controls, calculations, and limitations.', establishes: 'The paper provides an experimental framework for decomposing cellular respiration measurements.', boundary: 'Assay-derived respiration components are protocol- and cell-context-specific and do not establish health outcomes.' },
      ...
      { key: 'nad', title: 'NAD+ metabolism and its roles in cellular processes during ageing', authors: ['Evgeniya Katsyuba', 'Aurelio Romani', 'David Hofer', 'Johan Auwerx'], publisher: 'Nature Metabolism', publishedAt: '2020-01-06', url: 'https://doi.org/10.1038/s42255-019-0161-5', doi: '10.1038/s42255-019-0161-5', locator: 'NAD+ synthesis, salvage, compartmentation, consumption, and ageing sections.', establishes: 'The review maps major NAD+ synthesis and consumption pathways and their reported relationships with ageing biology.', boundary: 'Pathway associations and model-organism interventions do not establish benefit from a human supplement or treatment.' },
  ...
  },
  {
    ...
    sources: [
      ...
      { key: 'closed-loop', title: 'Closed-loop deep brain stimulation is superior in ameliorating parkinsonism', authors: ['Nir Rosin', 'Maya Slovik', 'Roman Mitelman', 'et al.'], publisher: 'Neuron', publishedAt: '2011-03-24', url: 'https://doi.org/10.1016/j.neuron.2011.01.023', doi: '10.1016/j.neuron.2011.01.023', locator: 'Closed-loop detection, stimulation timing, animal model, outcome comparisons, and Methods.', establishes: 'The study compares closed-loop and continuous stimulation in a specified primate model and protocol.', boundary: 'A model- and protocol-specific result does not establish superiority for all disorders, devices, endpoints, or patients.' },
  ...
  },
  {
    ...
    sources: [
      ...
      { key: 'nist-genai', title: 'Artificial Intelligence Risk Management Framework: Generative Artificial Intelligence Profile', authors: ['National Institute of Standards and Technology'], publisher: 'NIST', publishedAt: '2024-07-26', url: 'https://doi.org/10.6028/NIST.AI.600-1', doi: '10.6028/NIST.AI.600-1', locator: 'Risk-management actions for access control, monitoring, incident handling, human oversight, and third-party components.', establishes: 'The profile identifies risk-management practices applicable to generative-AI systems and their operational dependencies.', boundary: 'A risk framework does not prove a particular agent or sandbox is secure.' },
