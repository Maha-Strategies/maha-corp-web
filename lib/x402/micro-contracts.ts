...
export const MICRO_PRODUCTS = {
  'citation-binding-check': { amount: '5003', title: 'Citation Binding Check', description: 'Compare up to 20 declared source identities, revisions and locators. Returns exact mismatches and an integrity receipt. Does not fetch sources, establish passage existence or verify claim support.' },
  'revision-lineage-check': { amount: '5004', title: 'Revision Lineage Check', description: 'Check one initial or superseding revision transition against a declared predecessor. Returns lineage inconsistencies and an integrity receipt. Does not establish authenticity, semantic equivalence or inherited review approval.' },
  'audit-export-normalizer': { amount: '10002', title: 'Audit Export Normalizer', description: 'Normalize up to 100 metadata events into deterministic order, rejecting duplicate identifiers and malformed times or digests. Does not prove event occurrence, provenance or completeness against an external system.' },
