...
export const CELESTIAL_PRODUCTS = {
  'celestial-position-snapshot': { path: '/api/v1/calculations/positions', amount: '10000' },
  'celestial-chart-evidence': { path: '/api/v1/calculations/chart', amount: '50000' },
  'celestial-vimshottari-timing': { path: '/api/v1/calculations/vimshottari', amount: '100000' },
} as const
