...
export const NEXT_PRODUCTS = {
  ...
  'exact-linear-system': { amount: '34000', title: 'Exact Linear-System Solver', description: 'Solve a 1-8 variable rational linear system with rank, pivots, particular solution and null-space basis. Distinguishes unique, inconsistent and underdetermined systems. Not a floating-point conditioning or physical-model assessment.' },
  'bracketed-polynomial-root': { amount: '32000', title: 'Bracketed Polynomial Root Receipt', description: 'Bisect a degree 1-8 rational polynomial over a sign-changing rational bracket, with a maximum of 64 iterations. Returns a certified bracket or exact rational root. No arbitrary code, all-roots or uniqueness claim.' },
  'covariance-uncertainty': { amount: '27000', title: 'Covariance-Aware Uncertainty Propagation', description: 'Evaluate c-transpose C c for 1-8 declared sensitivities and an exactly symmetric positive-semidefinite covariance matrix. Returns exact variance and a rational square-root enclosure. First-order model only; no empirical covariance validation.' },
  ...
  'policy-version-comparison': { amount: '44000', title: 'Structured Policy-Version Comparison', description: 'Compare up to 40 caller-supplied policy clauses per version by stable ID, text and scope. Reports added, removed and changed clauses. Checks declared chronology, not legal effect, applicability or compliance.' },
  'control-evidence-gaps': { amount: '46000', title: 'Declared Control-Evidence Gap Check', description: 'Compare up to 40 declared policy/control requirements with revision- and scope-bound evidence descriptors. Reports missing, stale and rejected evidence. Does not inspect evidence content, evaluate control effectiveness or certify compliance.' },
  'mcp-contract-compatibility': { amount: '40000', title: 'Bounded MCP Tool Contract Compatibility', description: 'Compare required tool names and exact pinned input/output schema digests against a declared MCP server snapshot. Checks protocol version and transport. Not a network probe, general schema-subtyping proof or official conformance certificate.' },
  'tool-permission-diff': { amount: '42000', title: 'Tool Permission Change Analysis', description: 'Compare two explicit allow-only permission sets by tool, action and exact resource identifier. Reports additions, removals and wildcard additions. Does not resolve IAM inheritance, wildcard containment or authorize execution.' },
