...
export const NEXT_PRODUCTS = {
  'unit-uncertainty-conversion': { amount: '8000', title: 'Unit and Uncertainty Conversion', description: 'Convert one decimal measurement and standard uncertainty between explicitly supported length, mass, time or temperature units. Exact rational scale/offset arithmetic; no unit guessing, physical validation or expanded uncertainty.' },
  'exact-linear-system': { amount: '11000', title: 'Exact Linear-System Solver', description: 'Solve a 1-8 variable rational linear system with rank, pivots, particular solution and null-space basis. Distinguishes unique, inconsistent and underdetermined systems. Not a floating-point conditioning or physical-model assessment.' },
  'bracketed-polynomial-root': { amount: '9000', title: 'Bracketed Polynomial Root Receipt', description: 'Bisect a degree 1-8 rational polynomial over a sign-changing rational bracket, with a maximum of 64 iterations. Returns a certified bracket or exact rational root. No arbitrary code, all-roots or uniqueness claim.' },
  'covariance-uncertainty': { amount: '13000', title: 'Covariance-Aware Uncertainty Propagation', description: 'Evaluate c-transpose C c for 1-8 declared sensitivities and an exactly symmetric positive-semidefinite covariance matrix. Returns exact variance and a rational square-root enclosure. First-order model only; no empirical covariance validation.' },
  'divine-name-disambiguation': { amount: '14000', title: 'Tamil Divine-Name Disambiguation', description: 'Resolve an exact supported Tamil divine-name spelling into source-scoped relationship records at a pinned registry. Ambiguity and name coincidence remain explicit. No fuzzy universal synonymy, full source text or theological certification.' },
  'edition-verse-resolution': { amount: '36000', title: 'Edition-Specific Verse Reference', description: 'Resolve one printed pasuram number to its complete unit in the pinned Project Madurai/Hart atlas. Edition-specific, with exact unit locator. No conversion between numbering systems, translation reproduction or occurrence claims about a single verse.' },
  'reception-lineage-retrieval': { amount: '38000', title: 'Attributed Tamil Reception Lineage', description: 'Retrieve one supported reception comparison with separate source frames and exact locators from the pinned public atlas. No inferred ancestry, uninterrupted transmission, universal identity or source full text.' },
  'policy-version-comparison': { amount: '17000', title: 'Structured Policy-Version Comparison', description: 'Compare up to 40 caller-supplied policy clauses per version by stable ID, text and scope. Reports added, removed and changed clauses. Checks declared chronology, not legal effect, applicability or compliance.' },
  'control-evidence-gaps': { amount: '19000', title: 'Declared Control-Evidence Gap Check', description: 'Compare up to 40 declared policy/control requirements with revision- and scope-bound evidence descriptors. Reports missing, stale and rejected evidence. Does not inspect evidence content, evaluate control effectiveness or certify compliance.' },
  'mcp-contract-compatibility': { amount: '15000', title: 'Bounded MCP Tool Contract Compatibility', description: 'Compare required tool names and exact pinned input/output schema digests against a declared MCP server snapshot. Checks protocol version and transport. Not a network probe, general schema-subtyping proof or official conformance certificate.' },
  'tool-permission-diff': { amount: '21000', title: 'Tool Permission Change Analysis', description: 'Compare two explicit allow-only permission sets by tool, action and exact resource identifier. Reports additions, removals and wildcard additions. Does not resolve IAM inheritance, wildcard containment or authorize execution.' },
  'publication-bundle-consistency': { amount: '22000', title: 'Publication Bundle Consistency', description: 'Compare 2-8 declared article, registry and API views against one canonical URL, content digest, release digest and source-set digest. Reports stale, withdrawn and substituted views. No live fetch, release promotion or semantic content verification.' },
} as const
