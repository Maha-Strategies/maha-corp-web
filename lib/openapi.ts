  ...
  paths: {
    ...
    '/api/v1/compress': {
      post: {
        ...
        description: 'Deterministic context compilation available with a Maha API key or an autonomous $0.001 USDC payment over x402 v2 on Base. It does not retain source text or make factual-verification claims.', security: [{ credential: [] }, {}],
