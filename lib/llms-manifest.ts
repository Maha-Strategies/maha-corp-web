...
export function buildLlmsManifest(claims: readonly MpsClaim[]): string {
  return [
    ...
    '- GPU QUBO/Ising heuristic: https://www.mahastrategies.com/api/v1/jobs/qubo-ising',
    '- GPU tensor-network heuristic: https://www.mahastrategies.com/api/v1/jobs/tensor-network',
