...
test('The Cosmic Recursion reader FAQ is public, bounded and discoverable', () => {
  ...
  const catalogue = readFileSync(new URL('app/books/page.tsx', root), 'utf8')
  ...
  assert.match(catalogue, /guide: \{ title: 'What Survives the Compression\?', href: '\/books\/the-cosmic-recursion\/reader-faq' \}/)
