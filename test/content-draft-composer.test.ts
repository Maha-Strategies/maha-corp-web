...
import { contentDraftHash, contentDraftId, parseContentDraft, parseContentDraftAction, parseContentDraftRevision } from '../lib/content-draft-composer.ts'
...
test('revision input preserves the same bounded fields and requires a valid draft id', () => {
