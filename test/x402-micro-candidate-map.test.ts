...
const costs = JSON.parse(read('content/discovery/micro-next12-cost-observation-v6.json'))
...
test('map and examples regenerate deterministically; profiled implementation remains bound', () => {
  const files = ['content/discovery/micro-candidate-freeze-v1.json', 'content/discovery/micro60-selection-v1.json', 'content/discovery/micro-next12-cost-observation-v1.json', 'content/discovery/micro-next12-cost-observation-v2.json', 'content/discovery/micro-next12-cost-observation-v3.json', 'content/discovery/micro-next12-cost-observation-v4.json', 'content/discovery/micro-next12-cost-observation-v5.json', 'content/discovery/micro-next12-cost-observation-v6.json', 'content/discovery/microproduct-examples.json']
