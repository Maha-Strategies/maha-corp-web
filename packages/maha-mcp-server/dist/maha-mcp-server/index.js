...
import { EVIDENCE_BOUNDARY, MCP_SERVER_NAME, MCP_SERVER_VERSION, MCP_TOOLS, callMcpTool } from "../maha-mcp/index.js";
...
export function createMahaMcpServer(options = {}) {
...
function errorResult(tool, code, message) {
    return {
        content: [{
                type: 'text',
                text: JSON.stringify({
...
export async function startMahaMcpStdioServer(options = {}) {
