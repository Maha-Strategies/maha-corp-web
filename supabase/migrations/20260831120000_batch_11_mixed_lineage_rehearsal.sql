...
-- so no predecessor row is fabricated in the canonical release ledger.
create table if not exists public.batch_11_rehearsal_imported_lineage (
  ...
  constraint batch_11_rehearsal_imported_lineage_release_check
  ...
  constraint batch_11_rehearsal_imported_lineage_allowlist_check check (
