...
|---|---:|
| a. publishable now | **0** |
| b. blocked on canonical release | 33 |
| c. blocked on exact-revision review | 5 |
...
compilation capacity; it is that 33 inspected
...
blockers clear — 33 through release,
5 through review, and
...
1. Release the 33 records that are already
