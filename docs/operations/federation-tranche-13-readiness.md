# Federation Tranche 13 — local readiness
...
31 topics remain uninspected. They are predominantly this
...
- **COPE retraction guidelines** — HTTP 403
- **ACM artifact review and badging** — HTTP 403
- **NIH public access policy** — HTTP 403
- **ISO/IEC 42001 and the ISO catalogue** — paywalled
- **arXiv version availability policy** — served navigation and licence boilerplate rather than policy text
- **JATS tag library (sec, disp-formula)** — served navigation index and element headings rather than definitions
- **Crossref REST API documentation** — served site navigation rather than documentation body
